...
(function () {
  ...
  let apply_button_selector =
    "#buttons > input.bttn.blue.SaveButton.WithCancel";
  ...
  async function main() {
    ...
    for (const job_info of Array.from(job_infos)) {
      ...
      try {
        let apply_for_button = await get_selector_visible(
          apply_for_button_selector,
          30
        );
